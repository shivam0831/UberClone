...
public class IntroPageTransformer implements ViewPager.PageTransformer {
    ...
    public void transformPage(View page, float position) {
      ...
      // Fragment 1 -- Settings
            final ImageView img1 = page.findViewById(R.id.img1);
            if (img1 != null) img1.setTranslationX(pageWidthTimesPosition * 1.2f);

            final View title1 = page.findViewById(R.id.title1);
            if (title1 != null) title1.setTranslationX(pageWidthTimesPosition * 0.2f);

            final View desc1 = page.findViewById(R.id.desc1);
            if (desc1 != null) desc1.setTranslationX(pageWidthTimesPosition * 0.5f);


            final ImageView img2 = page.findViewById(R.id.img2);
            if (img2 != null) img2.setTranslationX(pageWidthTimesPosition * 1.2f);

            final View title2 = page.findViewById(R.id.title2);
            if (title2 != null) title2.setTranslationX(pageWidthTimesPosition * 0.2f);

            final View desc2 = page.findViewById(R.id.desc2);
            if (desc2 != null) desc2.setTranslationX(pageWidthTimesPosition * 0.5f);


            final ImageView img3 = page.findViewById(R.id.img3);
            if (img3 != null) img3.setTranslationX(pageWidthTimesPosition * 1.2f);

            final View title3 = page.findViewById(R.id.title3);
            if (title3 != null) title3.setTranslationX(pageWidthTimesPosition * 0.2f);

            final View desc3 = page.findViewById(R.id.desc3);
            if (desc3 != null) desc3.setTranslationX(pageWidthTimesPosition * 0.5f);
